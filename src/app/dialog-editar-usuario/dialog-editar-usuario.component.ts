...
@Component({
  ...
  <h1 mat-dialog-title class="font-weight-bold">Editar Usuario</h1>
</div>
<br>
  ...
  styleUrl: './dialog-editar-usuario.component.css'
})
export class DialogEditarUsuarioComponent {
  ...
  constructor(private dialogRef: MatDialogRef<DialogEditarUsuarioComponent>,@Inject(MAT_DIALOG_DATA) public data: { usuario_nombrecompleto: string; usuario_email: string; usuario_contrasena: string }) {
    this.usuario = { ...data };
  }
